...
SPECIALIST_DOMAINS = {
    "data-agent": {
        "name": "Data Agent",
        "description": "Unified database query specialist for all Wide World Importers data retrieval",
        "keywords": ["inventory", "stock", "customer", "order", "sales", "supplier", "payment", "data", "show", "list", "get", "query", "search"],
        "handoff_phrase": "This is outside my area. Let me connect you with the right specialist.",
    },
    "analyst": {
        "name": "Analyst Agent",
        "description": "Business intelligence and insights specialist - analyzes data and provides recommendations",
        "keywords": ["analyze", "analysis", "trend", "insight", "recommend", "recommendation", "forecast", "performance", "best", "worst", "top", "bottom"],
        "handoff_phrase": "This is outside my area. Let me connect you with the right specialist.",
    },
    "order-agent": {
        "name": "Order Agent",
        "description": "Order placement and fulfillment specialist",
        "keywords": ["order", "place", "purchase", "buy", "checkout", "confirm", "ship", "delivery"],
        "handoff_phrase": "This is outside my area. Let me connect you with the right specialist.",
    },
    "microsoft-docs": {
        "name": "Microsoft Docs Agent",
        "description": "Searches Microsoft Learn documentation and provides technical guidance",
        "keywords": ["microsoft", "documentation", "docs", "how to", "tutorial", "api", "reference", "learn", "azure"],
        "handoff_phrase": "This is outside my area. Let me connect you with the right specialist.",
    },
}
...
1. data-agent: Unified database queries across all Wide World Importers data
2. analyst: Business intelligence, analysis, insights, and recommendations
3. order-agent: Order placement and fulfillment orchestration
4. microsoft-docs: Microsoft Learn documentation, technical guidance, code samples

Your task: Analyze the user's message and determine which specialist should handle it.

Return a JSON object with:
{
  "domain": "data-agent|analyst|order-agent|microsoft-docs",
