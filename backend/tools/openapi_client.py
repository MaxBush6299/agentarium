...
def get_support_triage_tool(
    ...
    """
    spec_path = Path(__file__).resolve().parent.parent / "openapi" / "support-triage-api.yaml"
...
def get_ops_assistant_tool(
    ...
    Returns:
        OpenAPITool instance for Ops Assistant API
    """
    spec_path = Path(__file__).resolve().parent.parent / "openapi" / "ops-assistant-api.yaml"
